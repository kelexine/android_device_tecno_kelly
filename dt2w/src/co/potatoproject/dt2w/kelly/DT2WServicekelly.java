package co.potatoproject.dt2w.kelly;
...
public class DT2WServicekelly extends Service {
    private static final String TAG = "DT2WServicekelly";
    ...
    private class CustomSettingsObserver extends ContentObserver {
        ...
        void update() {
            ...
            SystemProperties.set("persist.sys.kelly.dt2w", dt2wEnabled ? "1" : "0");
        }
