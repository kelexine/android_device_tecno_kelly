package co.potatoproject.dt2w.KG5j;
...
public class DT2WServiceKG5j extends Service {
    private static final String TAG = "DT2WServiceKG5j";
    ...
    private class CustomSettingsObserver extends ContentObserver {
        ...
        void update() {
            ...
            SystemProperties.set("persist.sys.KG5j.dt2w", dt2wEnabled ? "1" : "0");
        }
